...
def initialisation(number_of_initial_elements = 50):
    ...
    EA.number_of_parents = 8
    EA.number_of_random = 5
    ...
    print(df.shape)
    df_search = df.sample(number_of_initial_elements)
...
def test_generation(EA, df, df_search, df_search_top, sp):
    ...
    results_top.dropna(subset=["target"], inplace=True)
    print("shape of results_top", results_top.shape)
