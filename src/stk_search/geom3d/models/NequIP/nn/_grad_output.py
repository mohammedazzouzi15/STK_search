...
class GradientOutput(GraphModuleMixin, torch.nn.Module):
    ...
    def forward(self, data: AtomicDataDict.Type) -> AtomicDataDict.Type:
        ...
        # # dict_keys(['edge_index', 'pos', 'batch', 'ptr', 'cell', 'pbc', 'edge_cell_shift', 'r_max', 'atom_types'])
        # print("edge_index", data['edge_index'].size())
        # print("pos", data['pos'].size())
        # print("atom_types", data['atom_types'].size())
        # print("batch", data['batch'].size())
        # print("r_max", data['r_max'].size())

        # print("ptr", data['ptr'].size())
        # print("cell", data['cell'].size())
        # print("pbc", data['pbc'].size())
        # print("edge_cell_shift", data['edge_cell_shift'].size())
        # del data['ptr']
        # del data['cell']
        # del data['pbc']
