# Credit to  https://github.com/drorlab/gvp-pytorch/blob/main/gvp/atom3d.py
...
class GVPConvLayer(nn.Module):
    ...
    def __init__(self, node_dims, edge_dims,
        ...
        if n_feedforward == 1:
            ...
            for _i in range(n_feedforward-2):
    ...
    def forward(self, x, edge_index, edge_attr,
        ...
        if autoregressive_x is not None:
            ...
            count = torch_scatter.scatter_add(torch.ones_like(dst), dst,
...
def _element_mapping(x):
    return {"H": 0, "C": 1, "N": 2, "O": 3, "F": 4, "S": 5, "Cl": 6, "CL": 6, "P": 7}.get(x, 8)
def _amino_acids(x):
    return {"ALA": 0, "ARG": 1, "ASN": 2, "ASP": 3, "CYS": 4, "GLU": 5, "GLN": 6, "GLY": 7, "HIS": 8, "ILE": 9, "LEU": 10, "LYS": 11, "MET": 12, "PHE": 13, "PRO": 14, "SER": 15, "THR": 16, "TRP": 17, "TYR": 18, "VAL": 19}.get(x, 20)
