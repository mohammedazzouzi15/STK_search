...
def main(num_iteration, num_elem_initialisation, test_name="test", case="slatm",search_space_loc = "data/input/search_space/test/search_space1.pkl"):
    ...
    if case == "slatm":
        ...
        ## load model
        config_dir = "/rds/general/user/cb1319/home/Geom3D/Geom3D/training/SchNet_Trans_80K"
        ...
        BO = Bayesian_Optimisation.Bayesian_Optimisation()
        BO.Representation = Representation_morgan_fp.RepresentationMorganFP()
        search_algorithm = BO
    else:
